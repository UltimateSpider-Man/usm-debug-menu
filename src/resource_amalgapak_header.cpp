...
bool resource_amalgapak_header::verify([[maybe_unused]] const mString& a2)
{
    ...
    if (v29) {
        ...
        auto v2 = a2.c_str();
        error("Error. The amalgapak file %s (v%s) is newer than this executable code (v%s).",
            v2,
            v19.c_str(),
            v18.c_str());
        // assert(0);
        ...
        error("Error. The amalgapak file %s (v%s) is older than this executable code (v%s).",
            v2,
            v19.c_str(),
            v18.c_str());
        // assert(0);
